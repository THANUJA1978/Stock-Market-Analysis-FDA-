...
def train_model(file_path):
    ...
    model_filename = os.path.join('stocks_model_random', f'{os.path.splitext(os.path.basename(file_path))[0]}.pkl')
    ...
    # Create a pipeline with an imputer and a random forest regressor model
    model = make_pipeline(SimpleImputer(strategy='mean'), RandomForestRegressor(random_state=42))
