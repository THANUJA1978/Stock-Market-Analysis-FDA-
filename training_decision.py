...
def train_model(file_path):
    ...
    model_filename = os.path.join('stocks_model_decision', f'{os.path.splitext(os.path.basename(file_path))[0]}.pkl')
    ...
    # Create a pipeline with an imputer and a decision tree regressor
    model = make_pipeline(SimpleImputer(strategy='mean'), DecisionTreeRegressor(random_state=42))
